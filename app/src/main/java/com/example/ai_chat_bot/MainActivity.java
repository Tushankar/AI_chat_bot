...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendMessage(String userMsg) {
        ...
        String url = "http://api.brainshop.ai/get?bid=183196&key=IlmtkzDIRnC8zV7e&uid=" + uid + "&msg=" + userMsg;


        Log.d("API Request", "Request URL: " + url);
        ...
        int maxRetries = 3;  // Set the number of retries
